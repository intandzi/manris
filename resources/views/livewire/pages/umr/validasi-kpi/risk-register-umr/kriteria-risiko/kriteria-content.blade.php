                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                <span wire:loading wire:target="showKemungkinan({{ $item->risk_id }})">
                                        ...
                                        <td>
                                            <button type="button" wire:click.prevent="showDampak({{ $item->risk_id }})"
                                                wire:loading.attr="disabled"
                                                ...
                                                <span wire:loading wire:target="showDampak({{ $item->risk_id }})">
                                                    <span class="spinner-border spinner-border-sm" role="status"
                                                        aria-hidden="true"></span>
                                                </span>
                                            </button>
                                        ...
                                        <td>
                                            <button type="button"
                                                ...
                                                <span wire:loading wire:target="showDeteksi({{ $item->risk_id }})">
                                                    <span class="spinner-border spinner-border-sm" role="status"
                                                        aria-hidden="true"></span>
                                                </span>
                                            </button>
