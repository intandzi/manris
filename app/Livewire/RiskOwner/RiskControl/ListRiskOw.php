...
class ListRiskOw extends Component
{
    use WithPagination;
    ...
    public function riskControl($id)
    {
        ...
        $this->redirect(route('riskControlStep.index', ['role' => $this->encryptedRole, 'konteks' => $encryptedKonteks, 'kpi' => $encryptedKpiId, 'risk' => $encryptedRiskId]), navigate:true);
    }
