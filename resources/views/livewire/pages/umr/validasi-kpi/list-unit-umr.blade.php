        ...
        <nav aria-label="breadcrumb" class="mb-2">
            <ol class="breadcrumb mb-0 p-2">
                ...
                <li class="breadcrumb-item active"><a
                        href="{{ route('kpiUnitUMR.index', ['role' => request()->query('role')]) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-inline-flex gap-2">
                                                    <button type="button"
                                                        wire:click.prevent="listKPIUnit({{ $unit->unit_id }})"
                                                        wire:loading.attr="disabled"
                                                        wire:target="listKPIUnit({{ $unit->unit_id }})"
                                                        class="btn btn-primary btn-sm d-flex text-center align-items-center position-relative">
                                                        <i class="ri-eye-fill me-1"></i>
                                                        Lihat KPI
                                                        <span
                                                            class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
                                                            style="font-size: 12px;">
                                                            {{ $this->countKpisWithStatusTrue($unit) }}
