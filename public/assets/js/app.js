...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        ...
        sessionStorage.setItem('__TECHMIN_CONFIG__', JSON.stringify(this.config));
        // localStorage.setItem('__TECHMIN_CONFIG__', JSON.stringify(this.config));

        document.querySelectorAll('#theme-settings-offcanvas input[type=radio]').forEach(function (checkbox) {
