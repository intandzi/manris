...
class KonteksRisikoOwRiskRegister extends Component
{
    use WithPagination;
    ...
    public function identifikasiRisiko($id)
    {
        ...
        $this->redirect(route('riskRegisterStepOw.index', ['role' => $this->encryptedRole, 'konteks' => $encryptedKonteks, 'kpi' => $encryptedKpiId]), navigate:true);
    }
