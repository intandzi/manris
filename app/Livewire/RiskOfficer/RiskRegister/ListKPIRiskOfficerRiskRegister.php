...
class ListKPIRiskOfficerRiskRegister extends Component
{
    ...
    public function konteksRisiko($id)
    {
        ...
        $this->redirect(route('officerRegisterKonteksRisikoOf.index', ['role' => $encryptedRole, 'kpi' => $encryptedId]), navigate: true);
    }
