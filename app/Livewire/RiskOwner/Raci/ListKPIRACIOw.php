...
namespace App\Livewire\RiskOwner\Raci;
...
class ListKPIRACIOw extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.pages.risk-owner.raci.list-kpi-raci', [
            'kpis'             => $kpis,
    ...
    public function raciIndex($id)
    {
        ...
        $this->redirect(route('raciOw.index', ['role' => $encryptedRole, 'kpi' => $encryptedId]), navigate: true);
    }
    ...
    {
        // FIND KPI
        $kpis = KPI::with(['unit', 'kategoriStandar', 'konteks.risk.raci.stakeholder'])
