...
class KonteksRisikoOfRiskControl extends Component
{
    use WithPagination;
    ...
    public function listRiskControl($id)
    {
        ...
        $this->redirect(route('officerListRisk.index', ['role' => $this->encryptedRole, 'konteks' => $encryptedKonteks, 'kpi' => $encryptedKpiId]), navigate:true);
    }
