                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select wire:model='jenisPerlakuan_id'
                                        {{ $isShowRencanaPerlakuan ? 'disabled' : '' }}
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="snow-editor"
                                        ...
                                        wire:model='rencanaPerlakuan_desc' aria-label="With textarea" cols="20" rows="10"
                                        {{ $isShowRencanaPerlakuan ? 'disabled' : '' }}></textarea>
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="">
                                <button type="button" class="btn btn-secondary"
                                    wire:click='closeModalRencanaPerlakuan' wire:loading.attr="disabled"
                                    wire:target="closeModalRencanaPerlakuan">
                                    Close
