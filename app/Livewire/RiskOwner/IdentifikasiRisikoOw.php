...
class IdentifikasiRisikoOw extends Component
{
    use WithPagination;
    ...
    {
        // RISK DATA
        $risks = Risk::with(['dampak', 'kemungkinan', 'deteksiKegagalan'])->where('konteks_id', $this->konteks_id)->search($this->searchRisk)
