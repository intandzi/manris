<div>
    ...
    @include('livewire.pages.risk-owner.risk-register.konteks-risiko-register.konteks-risiko-modal')
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="section-description-actions">
                            <button type="button" wire:click.prevent="create" class="btn btn-primary"
                                wire:loading.attr="disabled" wire:target="create"><i class="ri-add-line"></i> Create
                                Konteks Risiko
                                <span wire:loading class="ms-2" wire:target="create">
