                    ...
                    <form>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: bottom;">
                                            <p class="card-text" style="word-wrap: break-word;">{{ ucwords($kategoriStandar_id) }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="vertical-align: top;">:</td>
                                        <td style="vertical-align: bottom;">
                                            <p class="card-text" style="word-wrap: break-word;">{{ date('d M Y', strtotime($kpi_tanggalMulai)) }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="vertical-align: top;">:</td>
                                        <td style="vertical-align: bottom;">
                                            <p class="card-text" style="word-wrap: break-word;">{{ date('d M Y', strtotime($kpi_tanggalAkhir)) }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select 
                                            ...
                                            wire:model.debounce.100ms="kpi_periode"
                                            {{ $isShow ? 'disabled' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <span
                                            class="invalid-feedback">{{ $errors->first('kpi_kategoriKinerja') }}</span>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row -->
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="snow-editor"
                                            ...
                                            {{ $isShow ? 'disabled' : '' }}></textarea>
                                        <span
                                            class="invalid-feedback">{{ $errors->first('kpi_indikatorKinerja') }}</span>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row -->
                        @endif
                        ...
                        @if ($isEdit || !$isShow)
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label for="dokumenPendukung" class="form-label">Dokumen Pendukung (PDF,
                                            DOC,
                                            XLSX, IMG Max
                                            5MB)</label>
                                        <input type="file"
                                            class="form-control @error('dokumenPendukung') is-invalid @enderror"
                                            wire:model="dokumenPendukung">
                                        <span
                                            class="invalid-feedback">{{ $errors->first('dokumenPendukung') }}</span>
                                    </div>
                                </div> <!-- end col -->
                            </div> <!-- end row -->
                        @endif
