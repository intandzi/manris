...
namespace App\Livewire\RiskOwner\RiskControl;
...
class KonteksRisikoOwRiskControl extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.pages.risk-owner.risk-control.konteks-risiko-control.konteks-risiko-ow', [
    ...
    // REDIRECT TO LIST RISK CONTROL
    public function listRiskControl($id)
    {
        // SENDING KPI
        ...
        $this->redirect(route('listRiskOw.index', ['role' => $this->encryptedRole, 'konteks' => $encryptedKonteks, 'kpi' => $encryptedKpiId]), navigate:true);
    }
