        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if ($isEfektifitas)
                        @include('livewire.pages.umr.validasi-kpi.risk-register-umr.analisis-risiko.efektifitas-form')
                    @else
                        @include('livewire.pages.umr.validasi-kpi.risk-register-umr.analisis-risiko.kriteria-form')
                    @endif
