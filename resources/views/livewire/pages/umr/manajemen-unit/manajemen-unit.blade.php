        ...
        <nav aria-label="breadcrumb" class="mb-2">
            <ol class="breadcrumb mb-0 p-2">
                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-apps"></i>
                        App</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('manajemenUnit.index', ['role' => request()->query('role')]) }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button"
                                                    ...
                                                    wire:loading.attr="disabled" wire:target="editUnit({{ $unit->unit_id }})"
                                                    class="btn btn-warning btn-sm d-flex text-center align-items-center">
                                                    <i class="ri-pencil-fill" wire:loading.remove wire:target='editUnit({{ $unit->unit_id }})'>
                                                    </i>
