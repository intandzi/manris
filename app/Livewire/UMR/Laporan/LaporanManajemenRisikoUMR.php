...
namespace App\Livewire\UMR\Laporan;
...
class LaporanManajemenRisikoUMR extends Component
{
    use WithPagination;
    ...
    public function listKPILaporan($id)
    {
        ...
        $this->redirect(route('listKPILaporan-umr.index', ['role' => $this->role, 'unit' => $encryptedId]), navigate:true);
    }
