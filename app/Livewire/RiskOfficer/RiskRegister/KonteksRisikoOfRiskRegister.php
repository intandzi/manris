...
namespace App\Livewire\RiskOfficer\RiskRegister;
...
class KonteksRisikoOfRiskRegister extends Component
{
use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.pages.risk-owner.risk-register.konteks-risiko-register.konteks-risiko-ow', [
    ...
    public function identifikasiRisiko($id)
    {
        ...
        $this->redirect(route('officerRiskRegisterStep.index', ['role' => $this->encryptedRole, 'konteks' => $encryptedKonteks, 'kpi' => $encryptedKpiId]), navigate:true);
    }
