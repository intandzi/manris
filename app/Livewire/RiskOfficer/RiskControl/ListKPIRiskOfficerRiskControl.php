...
class ListKPIRiskOfficerRiskControl extends Component
{
    ...
    public function konteksRisiko($id)
    {
        ...
        $this->redirect(route('officerControlKonteksRisiko.index', ['role' => $encryptedRole, 'kpi' => $encryptedId]), navigate: true);
    }
