...
class ListKPIRiskOwnerRiskControl extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.pages.risk-owner.risk-control.list-kpi.list-kpi-risk-owner-RC', [
            'kpis'             => $kpis,
    ...
    public function konteksRisiko($id)
    {
        ...
        $this->redirect(route('controlKonteksRisikoOw.index', ['role' => $encryptedRole, 'kpi' => $encryptedId]), navigate: true);
    }
